  ...
  return (
    <div className="p-5">
      ...
      <Link href="./clubs/form">
        <button className="bg-green-700 text-white py-1 px-3 hover:bg-green-800 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors">
          Add clubs
        </button>
      </Link>
      <br />
