          ...
          <main className="flex flex-col lg:flex-row items-center justify-between gap-16">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8">
                Experience the future of education with EduTrack&apos;s comprehensive student tracking system. Empower
                your academic journey with cutting-edge tools and insights.
              </p>
              ...
              <Card className="bg-gray-800 border-gray-700">
                ...
                <CardContent>
                  <form onSubmit={login}>
                    ...
                    <br />
                    <Button type="submit" className="w-full mb-4 bg-blue-500 hover:bg-blue-600 text-white">
                      Log In
                    </Button>
                  </form>
                </CardContent>
